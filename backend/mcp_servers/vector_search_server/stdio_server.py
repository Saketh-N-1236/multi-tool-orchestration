...
This script runs the vector search MCP server in stdio mode for Cursor IDE integration.
"""
...
from mcp_servers.vector_search_server.server import VectorSearchMCPServer
